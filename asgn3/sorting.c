...
int main(int argc, char **argv) {
    ...
    while ((opt = getopt(argc, argv, OPTIONS)) != -1) {
        ...
        case 's': my_set = set_insert(my_set, SHELL_SORT); break;

        case 'b': my_set = set_insert(my_set, BATCHER_SORT); break;

        case 'q': my_set = set_insert(my_set, QUICK_SORT); break;

        case 'h': my_set = set_insert(my_set, HEAP_SORT); break;

        case 'r': random_seed = strtoul(optarg, NULL, 10); break;

        case 'n': len = strtoul(optarg, NULL, 10); break;

        case 'p': ele = strtoul(optarg, NULL, 10); break;
    ...
    if (set_member(my_set, SHELL_SORT) == 1 && set_member(my_set, BATCHER_SORT) == 1) {
        ...
        printf(
            "Heap Sort, %u elements, %lu move, %lu compares\n", len, test->moves, test->compares);
        ...
        printf(
            "Quick Sort, %u elements, %lu move, %lu compares\n", len, test->moves, test->compares);
        val = 0;
        ...
        printf(
            "Shell Sort, %u elements, %lu move, %lu compares\n", len, test->moves, test->compares);
        val = 0;
